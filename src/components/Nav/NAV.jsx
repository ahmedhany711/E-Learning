...
const menu = [
    ...
    { id: 3, name: "Instructors", link: "/Instructors" },
    { id: 4, name: "CreateCourse", link: "/CreateCourse" },
    { id: 5, name: "Students", link: "/students" },
    { id: 6, name: "Courses", link: "/Courses" },
    { id: 7, name: "Categories", link: "/Categories" },
    { id: 8, name: "Dashboard", link: "/Dashboard" },
                    ...
                    <div className=" py-3 w-full sm:py-0 z-[999999] ">
                        <Container className="flex justify-between items-center  my-0 gap-5 ">
                            ...
                            <div className=" font-heading  ">
                                <Link
                                    to="/"
                                    className="font-bold text-black flex gap-3  mr-2 no-underline items-center text-2xl  sm:text-3xl"
                                >
                            ...
                            {/* list of links */}
                            <div>
                                <ul className=" list-none flex flex-row sm:flex gap-[1px] md:gap-[18px] mr-auto items-center justify-start text-gray-800 my-1">
                                    {menu.map((data) =>
                                    {
                                        return (
                                            <li
                                            ...
                                            >
                                                <Link
                                                    to={data.link}
                                                    className={`
                                            no-underline font-semibold px-2 lg:text-xs text-[16px]
