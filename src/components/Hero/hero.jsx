              ...
              <div className="grid grid-cols-2 gap-20">
                ...
                <div class="">
                  <div className="" data-aos="fade-up">
                    {/* Titles */}
                    <div class="w-[750px] ">
                      <h5 className="text-title mb-8 text-6xl font-semibold">
                        Learn to Code
                      </h5>
                      <h1 className="text-headerText  mb-16 font-semibold text-2xl">
                        Business, Technology and Creative Skills taught by
                        industry experts. Explore a wide range of skills with
                        our professional tutorials.
                      </h1>
                      <p></p>
                    </div>
                    <div>
                        ...
                        <div class="form-inner">
                          <div class="flex items-center relative">
                            <input
                              ...
                              class="rounded-full max-w-6xl w-[2000px] h-[70px] pl-14 pr-10 placeholder-pl-10"
                              autocomplete="on"
                            />
                            <FaSearch class="text-sm text-primaryColor absolute  top-[45%] transform -translate-y-1/2 left-4 z-[1000]" />
                            <input type="hidden" value="course" name="ref" />
                            <FaArrowAltCircleRight className="text-3xl text-primaryColor hover:text-primaryColor/80 absolute top-[45%] transform -translate-y-1/2 right-4 z-[1000]" />
                          </div>
                        </div>
                      </form>
                    </div>
                    ...
                    <div className="w-[250px]">
                      <p className="text-headerText my-8 text-xl">
                ...
                <div>
                  <div className="pr-20 pl-10 ml-24">
                    <img
                      ...
                      width="630"
                      height="653"
                      src="https://dreamslms-wp.dreamstechnologies.com/wp-content/uploads/2023/01/object.png"
                ...
                <div className="flex justify-center items-center gap-5 ">
                  ...
                  <div className="w-[250px] h-[150px] z-[1000] shadow- rounded-2xl flex  bg-white text-center  hover:-translate-y-3 duration-300">
                    <div className="flex flex-col justify-center items-center mx-auto gap-3 ">
                      <div className="flex justify-center gap-4 items-center">
                        <div>
                          <FaPencilAlt className="text-title text-5xl" />
                        </div>
                  ...
                  <div className="w-[250px] h-[150px] z-[1000] shadow- rounded-2xl flex   bg-white text-center hover:-translate-y-3 duration-300">
                    <div className="flex flex-col justify-center items-center mx-auto gap-3 ">
                      <div className="flex justify-center gap-4 items-center">
                        <div>
                          <FaUser className="text-title text-5xl" />
                        </div>
                  ...
                  <div className="w-[250px] h-[150px] z-[1000] shadow- rounded-2xl flex  bg-white text-center hover:-translate-y-3 duration-300">
                    <div className="flex flex-col justify-center items-center mx-auto gap-3 ">
                      <div className="flex justify-center gap-4 items-center">
                        <div>
                          {" "}
                          <LiaCertificateSolid className="text-title text-5xl" />
                        </div>
