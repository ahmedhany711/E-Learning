...
const menu = [
    { id: 1, name: "Home", link: "/instructorsHome" },
    { id: 2, name: "Courses", link: "/CoursesForInstructor" },
    { id: 3, name: "CreateCourse", link: "/CreateCourse" },
    { id: 4, name: "Students", link: "/StudentsForInstructor" },
    { id: 5, name: "Dashboard", link: "/Dashboard" },
    { id: 6, name: "Profile", link: "/InstructorProfile" },
